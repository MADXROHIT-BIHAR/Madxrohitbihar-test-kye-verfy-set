...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Verification Gate Overlay (Using Arolinks API) */
        #verify-gate {
            position: fixed;
            top: 0;
            left: 0;
...
<body>
    ...
    <!-- Device Verification Gate (With Arolinks API & New Target URL) -->
    <div id="verify-gate">
        <div class="verify-card">
            <h3 class="verify-title">Device Verification</h3>
            <p class="verify-text">Get Key par click karke key copy karein aur yahan paste karein (24 Hours Validity).</p>
            
            <input type="text" id="accessKeyInput" class="verify-input" placeholder="ENTER ACCESS KEY" autocomplete="off">
            
            <button class="verify-secondary-btn" onclick="openAroLinks()">
                <i class="fa-solid fa-key"></i> Get Key
            </button>
            
            <button class="verify-main-btn" onclick="verifyUserKey()">
                <i class="fa-solid fa-lock-open"></i> Verify & Open App
            </button>
    ...
    <script>
            ...
            fetch(apiUrl)
                ...
                .then(data => {
                    if (data.status === "success" && data.shortenedUrl) {
                        ...
                        msgDiv.style.color = "var(--neon-pink)";
        ...
        function verifyUserKey() {
            const inputVal = document.getElementById('accessKeyInput').value.trim();
            const msgDiv = document.getElementById("status-msg");
            ...
            if (inputVal.length >= 4) {
                ...
                localStorage.setItem('madx_access_expiry', (currentTime + twentyFourHours).toString());
                ...
                setTimeout(() => {
                    inputEl.style.borderColor = "var(--border-neon)";
                }, 1000);
            }
        }
